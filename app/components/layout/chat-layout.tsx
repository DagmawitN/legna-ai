...
// ✅ Updated: Removed tigrinya from AppLanguage
export type AppLanguage = "english" | "amharic" | "oromigna"
    ...
    <div className="flex h-screen bg-background overflow-hidden">
      {currentIsAuthenticated && (
        <Sidebar
          ...
          language={language} // ✅ now fully type-safe
      ...
      {!currentIsAuthenticated && (
        <div className="w-20 bg-sidebar border-r border-sidebar-border flex-shrink-0 flex flex-col items-center py-3 space-y-3">
          ...
          >
            <svg
              className="h-5 w-5 text-sidebar-foreground group-hover:text-primary"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
      ...
      <div className="flex flex-col flex-1 overflow-hidden w-full">
        {!currentIsAuthenticated && languageSelected && (
          <div className="flex items-center justify-between border-b border-border/30 bg-background/50 px-4 py-3 md:px-6">
