      ...
      <div className="hidden md:block flex-1 max-w-2xl mx-8">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-xl bg-gray-50 border border-gray-200 text-gray-700 placeholder-gray-500 text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30 transition-all duration-300"
          />
        </div>
      </div>
